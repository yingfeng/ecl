...
import { $getNodeByKey, $getRoot, $isElementNode, type ElementNode, type LexicalNode } from 'lexical';
    ...
    <>
      <div style={{
        ...
        <button
          ...
          style={{
            padding: '4px 10px', border: showSource ? '1px solid var(--nim-primary)' : '1px solid transparent',
        ...
        <button
          ...
          className="nim-mode-btn"
          style={{
            padding: '4px 10px', border: showToc ? '1px solid var(--nim-primary)' : '1px solid transparent',
            borderRadius: 4, cursor: 'pointer', fontSize: 12, fontWeight: 500,
      ...
      {showToc && tocItems.length > 0 && (
        <div style={{
          position: 'absolute', top: 40, left: 80, zIndex: 50,
          ...
          <div style={{ padding: '8px 12px', fontSize: 11, fontWeight: 600, color: 'var(--nim-text-faint)', textTransform: 'uppercase', letterSpacing: 0.5, borderBottom: '1px solid var(--nim-border)' }}>
            Table of Contents
          </div>
          {tocItems.map((item, i) => (
            <div
              ...
              style={{
                ...
                fontSize: 13, cursor: 'pointer', color: 'var(--nim-text)',
