...
export function createListTransformer(listType: ListType, regex: RegExp): ElementTransformer {
  return {
...
export const UNORDERED_LIST: ElementTransformer = createListTransformer('bullet', UNORDERED_LIST_REGEX);
export const ORDERED_LIST: ElementTransformer = createListTransformer('number', ORDERED_LIST_REGEX);
export const CHECK_LIST: ElementTransformer = createListTransformer('check', CHECK_LIST_REGEX);
